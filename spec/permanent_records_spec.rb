...
describe PermanentRecords do
  ...
  describe '#destroy' do
    ...
    context 'when validations fail' do
      before do
        allow_any_instance_of(Hole).to receive(:valid?) { false }
      end
      it 'raises' do
      ...
      context 'that are permanent' do
        ...
        context 'with has_many cardinality' do
          ...
          context 'when error occurs' do
            before { allow_any_instance_of(Hole).to receive(:valid?) { false } }
          ...
          context 'with force delete' do
            ...
            context 'when error occurs' do
              before do
                allow_any_instance_of(Difficulty).to receive(:destroy) { false }
              end
